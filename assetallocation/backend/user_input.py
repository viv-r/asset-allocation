...
INVESTMENT_CLASS_DICT = {
    ...
    'U.S. corporate bonds (investment-grade, AAA rated)': invest_dataframe('./Data/BAMLCC0A1AAATRIV.csv'),
    'U.S. corporate bonds (investment-grade, BBB rated)': invest_dataframe('./Data/BAMLCC0A1BBBTRIV.csv'),
